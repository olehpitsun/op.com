    ...
    $("document").ready(function(){
        $(".form-horizontal").submit(function(){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo $action; ?>", //Relative or absolute path to response.php file
                data: data,
                success: function(data) {
                    ...
                    $("#the-return").html(
                            ...
                            "<b> Адресу </b>" + obj.address_1 + " " + obj.postcode + " <b>для </b>" + obj.firstname + " " +
                                obj.middlename + " " + obj.lastname + " <b>успішно додано </b>"
                    );
                    document.getElementsById('input-firstname').value="";
                }
            });
            return false;
        });
...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"> <?php echo $content_top; ?>
      <h2><?php echo $text_edit_address; ?></h2>vcvxcv
        ...
        <div class="buttons clearfix">
          ...
          <div class="pull-right">
            <input type="submit" name="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary" />
          </div>
        </div>
      </form>
        <div class="alert alert-success" role="alert" id="the-return">
