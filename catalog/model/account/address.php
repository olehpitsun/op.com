...
class ModelAccountAddress extends Model {
	...
	public function getAjaxAddresses($startnum){
		$address_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "address WHERE customer_id = '" . (int)$this->customer->getId() . "' LIMIT {$startnum}, 5");
	...
	public function getAddresses() {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "address WHERE customer_id = '" . (int)$this->customer->getId() . "' LIMIT 5");
